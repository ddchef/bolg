<template>
  <main class='container'>
    <span v-for="i in 40" :key="'s'+i" class="particle">4</span>
    <span v-for="i in 40" :key="'z'+i" class="particle">0</span>
    <div class="content">
      ...
      <router-link tag="button" to="/" class="btn green">Go back to home</router-link>
    </div>
  </main>
</template>
<style lang="scss">
